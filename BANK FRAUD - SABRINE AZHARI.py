...
data_original = pd.read_csv("C:/Users/PC/Desktop/MACHINE LEARNING/bank_transactions_data_2.csv")

# Afficher les types d'origine
...
file_path = r'C:\Users\PC\Desktop\MACHINE LEARNING\bank_transactions_data_2.csv'
...
# Calculer la distance de chaque point par rapport au centre de son cluster
data['DistanceToCentroid'] = [np.linalg.norm(x - kmeans.cluster_centers_[cluster]) 
                              for x, cluster in zip(X.values, data['Cluster'])]
...
# Optionnel : Visualiser les anomalies
plt.scatter(data.index, data['TransactionAmount'], c=data['Anomaly'], cmap='coolwarm')
plt.title('Détection d\'Anomalies - K-means Clustering')
plt.xlabel('Index')
plt.ylabel('Transaction Amount')
plt.show()
...
plt.scatter(data.index, data['TransactionAmount'], c=data['Anomaly'], cmap='coolwarm')
plt.title('Détection d\'Anomalies - One-Class SVM')
plt.xlabel('Index')
plt.ylabel('Transaction Amount')
plt.show()
...
plt.scatter(data.index, data['TransactionAmount'], c=data['Anomaly'], cmap='coolwarm')
plt.title('Détection d\'Anomalies - Autoencoder')
plt.xlabel('Index')
plt.ylabel('Transaction Amount')
plt.show()
...
plt.scatter(data.index, data['TransactionAmount'], c=data['Anomaly_LOF'], cmap='coolwarm')
plt.title('Détection d\'Anomalies - Autoencoder')
plt.xlabel('Index')
plt.ylabel('Transaction Amount')
plt.show()
...
# Visualisation
plt.scatter(data['TransactionAmount'], data['TransactionDuration'], c=data['GMM_Cluster'], cmap='coolwarm')
...
# Visualiser les anomalies
plt.scatter(data.index, data['TransactionAmount'], c=data['Anomaly'], cmap='coolwarm')
plt.title('Détection d\'Anomalies - Agglomerative Clustering')
plt.xlabel('Index')
plt.ylabel('Transaction Amount')
plt.show()
